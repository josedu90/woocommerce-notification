			...
			<form method="post" action="" class="vi-ui form">
				...
				<div class="vi-ui bottom attached tab segment" data-tab="design">
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							<th scope="row">
								<label><?php esc_html_e( 'Border radius', 'woocommerce-notification' ) ?></label>
							</th>
							<td>
								<div class="vi-ui form">
									<div class="inline fields">
										...
										<label><?php esc_html_e( 'px', 'woocommerce-notification' ) ?></label>
									</div>
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							<th scope="row">
								<label for="<?php echo self::set_field( 'message_hidden_effect' ) ?>">
									<?php esc_html_e( 'Message hidden effect', 'woocommerce-notification' ) ?>
								</label>
							</th>
							<td>
					...
					<table class="optiontable form-table">
						...
						<tr valign="top">
							...
							<td>
								...
								<p class="description"><?php esc_html_e( 'Turn on is hidden notification on Home page', 'woocommerce-notification' ) ?></p>
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								...
								<p class="description"><?php esc_html_e( 'Turn on is hidden notification on Checkout page', 'woocommerce-notification' ) ?></p>
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								...
								<p class="description"><?php esc_html_e( 'Turn on is hidden notification on Cart page', 'woocommerce-notification' ) ?></p>
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
							...
							<td>
								<div class="fields">
									<div class="ten wide field">
										<input class="villatheme-autoupdate-key-field" type="text" name="<?php echo self::set_field( 'key' ) ?>"
											   value="<?php echo self::get_field( 'key' ) ?>" />
									</div>
									<div class="six wide field">
										<span class="vi-ui button green villatheme-get-key-button" data-href="https://api.envato.com/authorization?response_type=code&client_id=villatheme-download-keys-6wzzaeue&redirect_uri=https://villatheme.com/update-key" data-id="16586926"><?php echo esc_html__( 'Get Key', 'woocommerce-notification' ) ?></span>
									</div>
								</div>
